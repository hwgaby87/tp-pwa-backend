...
class ChannelRepository {
    ...
    async getDeleted(workspace_id) {
        try {
            const channels = await ChannelModel.find({ fk_id_workspace: workspace_id, is_active: false })
            ...
            throw new ServerError("Error al obtener la lista de canales eliminados", 500);
        }
    }
    ...
    async getByIdIncludeInactive(channel_id) {
        try {
