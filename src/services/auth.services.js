...
class AuthService {
    ...
    async verifyEmail({ verify_email_token }) {
        ...
        //Si el token es válido, devuelve el payload (en este caso email y name)
        //Si el token no es válido o expiró, lanza un error que se puede capturar con el bloque catch
        try {
            ...
            if (error instanceof jwt.TokenExpiredError) {
                ...
                //Lee el token pero no lo decodificado porque expiró, pero se puede leer el payload para reenviar otro mail de verificación 
                // sin necesidad de que el usuario vuelva a registrarse
